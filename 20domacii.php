...
<head>
    ...
    *{ font-size:24px; font-weight:bold;}
    ...
    .black:hover{background-color:black; color:yellow}
    </style>
    <title>20 domaci</title>
</head>
<body>
<?php
        ...
        echo "<ul>";
            ...
            while($row=$result->fetch_assoc())
            {
                ...
                $year =  date("Y",strtotime($row['dob']));
                    ...
                    if($year%2==0)
                    {
                        echo "<li class='blue'>".($br++);
                        echo "&nbsp";
                        echo "<span class='blue'>".$row['name']."</span>";
                        echo "&nbsp";
                        echo "<span class='blue'>(".$row['username'].")</span>";
                    }
                    else
                    {
                        echo "<li class='black'>".($br++);
                        echo "&nbsp";
                        echo "<span class='black'>".$row['name']."</span>";
                        echo "&nbsp";
                    ...
                    echo "<span>";
                        if($jatebe==0)
                        {
                            if($timene==0)
                            {
                                echo "<a href='20domacii.php?dodaj=$friend_id'>Zaprati korisnika</a>";
                            }
                            else
                            {
                                echo "<a href='20domacii.php?dodaj=$friend_id'>Uzvrati pracenje</a>";
                            }
                        }
                        else
                        {
                            echo "<a href='20domacii.php?brisi=$friend_id'>Otkazi pracenje</a>";
                        }
